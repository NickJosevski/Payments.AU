...
namespace Payments.SecurePay
{
    ...
    public enum SecurePayStatusCodes
    {
        ...
        AdministrationError = 89,
        CutOffInProgress = 90,
        FinancialInstitutionNotFound = 92,
        TransCannotBeCompleted = 93,
        DuplicateTransaction = 94,
        ReconcileError = 95,
        SystemMalfunction = 96,
        ReconcillationTotalsReset = 97,
        MacError = 98,
        ReservedForNationalUse = 99,
        TriggeredPaymentNotFound = 333,
